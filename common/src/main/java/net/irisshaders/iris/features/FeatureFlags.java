...
public enum FeatureFlags {
	...
	CUSTOM_IMAGES(() -> true, () -> IrisMixinPlugin.usingVulkan ? VulkanCapabilities.supportsCustomImages() : IrisRenderSystem.supportsImageLoadStore()),
	PER_BUFFER_BLENDING(() -> true, () -> IrisMixinPlugin.usingVulkan ? VulkanCapabilities.supportsPerBufferBlending() : IrisRenderSystem.supportsBufferBlending()),
	COMPUTE_SHADERS(() -> true, () -> IrisMixinPlugin.usingVulkan ? VulkanCapabilities.supportsComputeShaders() : IrisRenderSystem.supportsCompute()),
	TESSELLATION_SHADERS(() -> true, () -> IrisMixinPlugin.usingVulkan ? VulkanCapabilities.supportsTessellationShaders() : IrisRenderSystem.supportsTesselation()),
	ENTITY_TRANSLUCENT(() -> true, () -> true),
	REVERSED_CULLING(() -> true, () -> true),
	BLOCK_EMISSION_ATTRIBUTE(() -> true, () -> true),
	CAN_DISABLE_WEATHER(() -> true, () -> true),
	SSBO(() -> true, () -> IrisMixinPlugin.usingVulkan ? VulkanCapabilities.supportsShaderStorageBuffers() : IrisRenderSystem.supportsSSBO()),
