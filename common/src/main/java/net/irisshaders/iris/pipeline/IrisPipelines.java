...
public class IrisPipelines {
	...
	/** Backend-neutral lookup used by the Vulkan shadow submission path. */
	@Nullable
	public static ShaderKey getShadowPipeline(RenderPipeline shader) {
		return coreShaderMapShadow.getOrDefault(shader, FAKE_FUNCTION).apply(null);
	}
