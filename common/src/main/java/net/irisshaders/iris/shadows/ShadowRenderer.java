...
public class ShadowRenderer {
	...
	public void renderShadows(LevelRendererAccessor levelRenderer, Camera playerCamera, CameraRenderState renderState) {
		...
		// Feature rendering can submit outlined item and equipment vertices to the
		// dedicated outline source. Match vanilla's render-pass lifecycle so those
		// builders do not retain vertices across shadow frames.
