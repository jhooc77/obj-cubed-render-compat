...
tasks {
	test {
		// Vulkan compatibility checks are command-line smoke programs registered
		// by vulkan-smoke.init.gradle, not JUnit test cases. Gradle 9.5 otherwise
		// fails merely because src/test contains those executable harnesses.
