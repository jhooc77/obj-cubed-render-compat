...
|---|---|---|---|
| 26.1–26.1.2 | Fabric + Iris 1.10.9/1.11.2 + 해당 Iris에 맞는 Sodium | `obj-cubed-iris-compat-26.1-universal-*.jar` | MC 26.1/26.1.1/26.1.2와 Sodium 0.8.9–0.8.12/0.9.1 자동 검증 완료, 게임 내 최종 검증 필요 |
...
- Fabric 동반 모드는 Minecraft 26.1/26.1.1/26.1.2, Iris 1.10.9 + Sodium 0.8.9/0.8.10/0.8.11/0.8.12와 Iris 1.11.2 + Sodium 0.9.1 조합에서 컴파일하고 대상 API와 GLSL 주입을 확인합니다.
