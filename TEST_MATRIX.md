...
|---|---|---|---|---|
| F1 | 26.1 | Iris 1.10.9 + Sodium 0.8.x | `obj-cubed-iris-compat-mc26.1-iris1.10.9-0.2.0.jar` | 셰이더 off/on, 공통 장면 |
| F2 | 26.1.1 | Iris 1.10.9 + Sodium 0.8.x | `obj-cubed-iris-compat-mc26.1.1-iris1.10.9-0.2.0.jar` | 셰이더 off/on, 공통 장면 |
| F3 | 26.1.2 | Iris 1.10.9 + Sodium 0.8.9–0.8.12 | `obj-cubed-iris-compat-mc26.1.2-iris1.10.9-0.2.0.jar` | 셰이더 off/on, 공통 장면 |
| F4 | 26.1.2 | Iris 1.11.2 + Sodium 0.9.1 | `obj-cubed-iris-compat-mc26.1.2-iris1.11.2-0.2.0.jar` | 셰이더 off/on, 공통 장면 |
...
F1–F4는 해당 행의 JAR 하나만 설치합니다. 동반 모드에서 블록 파괴 금은 바닐라 carrier 기준입니다.
